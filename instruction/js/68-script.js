// e.target chooses selected value
...
ddlCountries.addEventListener("change", (z)=>{
    const selectedValue = z.target.value;
...
const fillCountryTable = (country) => {
    ...
    const map = `<a href="https://google.com/maps/@${country.latlng},6z" target="_blank">Go to map</a>`;
